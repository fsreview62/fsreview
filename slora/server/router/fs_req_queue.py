...
class FSReqQueue(ReqQueue):
    ...
    def _can_add_new_req(self, req, lora_ranks):
        ...
        #print(f"need_max_token_num: {need_max_token_num}, self.max_total_tokens: {self.max_total_tokens}, self.adapter_size: {self.adapter_size}, len(self.cache_len_list): {len(self.cache_len_list)}, self.running_max_req_size: {self.running_max_req_size}")
