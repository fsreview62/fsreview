...
class HttpServerManager:
    ...
    async def generate(self, adapter_dir, prompt, sampling_params, request_id, sys_len, app, input99app, sys99app, output99app, priorityfactor, llmcalls, app_limit, llmcalls_made, interaction_id):
        ...
        self.send_to_router.send_pyobj((adapter_dir, prompt_ids, sampling_params, request_id, sys_len, app, input99app, sys99app, output99app, priorityfactor, llmcalls, app_limit, llmcalls_made, interaction_id))
        event = asyncio.Event()
