...
paper_suite = {
    ...
    "real_m365_trace": BenchmarkConfig(
        num_adapters=[-1],
        alpha=[-1],
        req_rate=[3.5],
        cv=[-1],
    ...
    "overload": BenchmarkConfig(
        ...
        alpha = [-1],
        #req_rate = [[3, 3]],
        req_rate = [np.random.uniform(3, 5, 50).tolist()],
        #req_rate = [[1.5, 1.5]], 
        #req_rate = [[1.5, 3]],
        #req_rate = [[8, 16]],
        cv = [-1],
    ...
    "proportional2": BenchmarkConfig(
        num_adapters = [3],
        alpha = [-1],
        req_rate = [[0.25, 0.5, 0.25]],
        cv = [-1],
        duration = [60 * 10],
        input_range = [[256, 257]],
        output_range = [[256, 257]],
